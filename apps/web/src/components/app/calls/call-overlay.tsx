...
export function CallOverlay({
  ...
  return (
    <div className="suzi-call-overlay-root fixed inset-0 z-[1300] flex flex-col bg-[rgba(8,9,22,0.97)] pb-[calc(env(safe-area-inset-bottom)+5.25rem)] sm:pb-[calc(env(safe-area-inset-bottom)+1rem)]">
      ...
      <div className="flex items-center justify-center gap-5 px-5 pb-3 pt-3 sm:pb-9">
        <button
          type="button"
          onClick={onToggleMic}
