...
export default function RegisterPage() {
  ...
  return (
    <section className="rounded-[2.1rem] border border-white/12 bg-[linear-gradient(180deg,rgba(49,10,82,0.78),rgba(33,6,55,0.84))] p-6 shadow-[0_24px_80px_rgba(8,0,24,0.48),inset_0_1px_0_rgba(255,255,255,0.1)] backdrop-blur-xl sm:p-8">
