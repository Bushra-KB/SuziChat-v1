  ...
  return (
    <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
      ...
      <Panel className="p-5">
        ...
        <div className={`mt-5 aspect-[9/14] rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.01))] ${featured.tone}`} />
